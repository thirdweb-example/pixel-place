...
export const NEXT_PUBLIC_THIRDWEB_SERVER_WALLET_ADDRESS =
  process.env.NEXT_PUBLIC_THIRDWEB_SERVER_WALLET_ADDRESS || "";
...
if (!NEXT_PUBLIC_THIRDWEB_SERVER_WALLET_ADDRESS) {
  throw new Error("NEXT_PUBLIC_THIRDWEB_SERVER_WALLET_ADDRESS is not set");
}
